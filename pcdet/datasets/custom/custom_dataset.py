...
class CustomDataset(DatasetTemplate):
    ...
    def get_label(self, idx):
        label_file = Path(self.root_path) / 'labels' / f'{idx}.txt'
    ...
    def get_lidar(self, idx):
        lidar_file = Path(self.root_path) / 'points' / f'{idx}.npy'
    ...
    def create_groundtruth_database(self, info_path=None, used_classes=None, split='train'):
        ...
        db_info_save_path = Path(self.root_path) / f'custom_dbinfos_{split}.pkl'
        ...
        # Output the num of all classes in the database
...
def create_custom_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    ...
    print('------------------------Start creating ground truth database for data augmentation------------------------')
    dataset.set_split(train_split)
