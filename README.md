...
- If `nvcc --version` shows a version which is not the one you want, please refer the steps [here](documentations/SwapCUDAVersion.md). A step-by-step guide is provided with screenshots to guide you.
